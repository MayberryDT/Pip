...
export const agentEvalCases = [
  ...
  {
    id: "phone-pip-cost",
    description: "Pip cost wording should return public web pricing copy.",
    message: "What does Pip cost?",
    expectedTools: ["get_trust_policy"],
    expectedTextPatterns: ["\\$7\\.99/month", "Stripe"],
    forbiddenTextPatterns: ["\\$2\\.99"],
    expectNoCards: true,
  },
  {
