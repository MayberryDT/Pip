...
select
  ...
  has_table_privilege('authenticated', 'public.billing_customers', 'select') as authenticated_can_select_billing_customers,
  has_table_privilege('authenticated', 'public.billing_subscriptions', 'select') as authenticated_can_select_billing_subscriptions,
  has_table_privilege('authenticated', 'public.stripe_webhook_events', 'select') as authenticated_can_select_stripe_webhook_events,
