...
| Financial info | Other financial info | Yes | Required for core functionality after setup | App functionality | Includes monthly savings, savings goals, account preferences, recurring bill/income inferences, sync status, and financial summaries. |
