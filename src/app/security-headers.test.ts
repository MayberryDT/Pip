...
const contentSecurityPolicy = [
  ...
  "object-src 'none'",
  "script-src 'self' 'unsafe-inline' https://cdn.plaid.com https://*.plaid.com https://analytics.animasai.co",
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https:",
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.plaid.com https://connect.teller.io https://analytics.animasai.co",
