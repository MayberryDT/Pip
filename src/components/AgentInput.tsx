...
export function AgentInput({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="focus-ring ui-pressable pip-composer-submit absolute bottom-2 right-2 grid h-11 w-11 place-items-center rounded-full bg-ink text-paper shadow-[0_12px_28px_rgba(43,42,39,0.16)] hover:bg-ink/[0.82] disabled:pointer-events-none disabled:opacity-0"
