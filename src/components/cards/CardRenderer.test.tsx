  ...
  return [
    ...
    },
    {
      ...
      card: {
        ...
        summary: "$4,500 left for Japan trip. Tracked in Pip only. Pip does not move money.",
      },
      expectedText: [
        "Savings Goals",
      ...
      absentText: ["Monthly plan", "Tracked only."],
    },
    {
      ...
      card: {
        ...
        title: "Savings Goals",
        summary: "1 active savings goal tracked in Pip. Pip does not move money.",
        activeGoalCount: 1,
