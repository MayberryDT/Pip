...
import { getClientPipPlatform, type PipPlatform } from "@/lib/platform/client-platform";
...
export function PipHome({
  ...
  useEffect(() => {
    setClientPlatform(getClientPipPlatform());
  }, []);
...
function getPlatformLabel(_platform: PipPlatform): string {
  return "Web";
}
