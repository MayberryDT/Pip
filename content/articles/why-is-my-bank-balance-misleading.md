---
title: "Why is my bank balance misleading?"
description: "Your bank balance shows total money, not what’s already spoken for. See why it can trick you and how Pip’s daily number gives a clearer picture."
slug: "why-is-my-bank-balance-misleading"
status: "published"
seo.title: "Why Is My Bank Balance Misleading? Discover the True Spending Number"
seo.description: "Learn why your bank balance can trick you into overspending and how Pip’s Spendable Cash Today shows what’s actually safe to use."
faq:
  - question: "Why doesn’t my bank balance reflect money that’s already spent?"
    answer: "Credit card payments and pending debits haven’t cleared, so the balance looks higher than it is. Pip accounts for these commitments."
  - question: "Can Pip help me see what I can spend right now?"
...
| **Total bank balance**    | **$5,000** |
| Rent due in 2 days        | -$1,500  |
| Car payment due next week | -$300    |
| Credit card payment pending | -$450  |
...
Pip is designed to give you a clear daily spending number without any heavy lifting. You securely connect your main spending account using a read-only link; Pip never sees or stores your bank username or password. Each morning, Pip fetches your latest balance, then subtracts the near-term bills you’ve entered, your protected monthly savings, and any pending card or debit commitments. What’s left is your [Spendable Cash Today](/blog/what-is-spendable-cash-today), a simple number that answers “how much can I safely use right now?” Because Pip doesn’t need categories or complex budgets, it fits a daily rhythm: you check your number, decide, and move on. Pip does not move money and is not financial advice; it’s a companion that helps you see the money that’s truly yours to spend. For a deeper look at how the calculation works, see [How the number works](/how-the-number-works). And because the whole system is read-only and bank-grade encrypted, your data stays safe. Learn more on our [Security](/security) page.
